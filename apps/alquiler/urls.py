...
from apps.alquiler.views import RegistradorDelete, index, RegistradorList, RegistradorInsert, RegistradorEdit, AlquilerList, AlquilerInsert, AlquilerUpdate, AlquilerDelete
urlpatterns = [
